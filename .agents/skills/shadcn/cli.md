...
Configuration is read xt, start, vite, next-monorepo, react-router) | —       |
...
Applies a preset to an existing project, overwrfrom `components.json`.
...
| ----------------------- | ----- | --------------------------------------------------------- | ------- |
| `--template <template>` | `-t`  | Template (neiting preset-driven config, fonts, CSS variables, and detected UI components.
